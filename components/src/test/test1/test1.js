...
var page = (function(){
  ...
  fn["initHtml"] = function(){
    ...
    store.set("liuqianwen",{"liqi":"dongjingfeng"});
    //根据url来获取模板
    ...
    //调用工具模块中的页面元素赋值API
    ToolBox.valPage($("body"),{input1:"和风",input2:"夙愿",input3:"羽翼",input4:"天穹"});
    ToolBox.valPage($("body"),{div1:"和风夙愿",div2:"羽翼天穹",div3:"羽翼",div4:"天穹"});
