...
var page = (function(){
  ...
  fn.loadtheData = function(params){
    CbTplSelect.loadSelect($(this),{params:params});
  }
  //通过传入data来加载多选框数据
  fn.loadtheData2 = function(params) {
    CbTplSelect.loadSelect($(this),{data:{outputParamList:[
      {
        "text1":"类型1",
        "value1":"01",
        "disabled":true,
  ...
  fn.appendtheData = function(params){
    CbTplSelect.appendSelect($(this),{params:params});
  }
  //重新加载数据
  fn.reLoadFn = function(params){
    CbTplSelect.reLoadSelect($(this));
  }
  //选中所有的多选框
  fn.val = function(params){
    CbTplSelect.val($(this),"02");
  }
  //取消所有选中框的选中状态
  fn.val2 = function(params){
    alert(CbTplSelect.val($(this)));
  }
  //事件函数绑定位置
  ...
  EventListenr.addListenr("val",fn["val"]);
  EventListenr.addListenr("val2",fn["val2"]);
  return model;
})();
